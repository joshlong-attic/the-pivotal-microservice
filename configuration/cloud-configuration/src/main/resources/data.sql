...
insert into RESERVATION( FIRST_NAME, LAST_NAME) values( 'Josh', 'Long');
insert into RESERVATION( FIRST_NAME, LAST_NAME) values( 'Josh', 'McKenty');
insert into RESERVATION( FIRST_NAME, LAST_NAME) values( 'Andrew', 'Clay Shafer');
